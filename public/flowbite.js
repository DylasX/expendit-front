...
*/
      ...
      /***/ 554: /***/ function (__unused_webpack_module, exports) {
        ...
        function parseFormatString(format) {
          ...
          var partParserKeys = Object.keys(parseFns).reduce(function (
            keys,
            key
          ) {
        ...
        function processOptions(options, datepicker) {
          ...
          if (inOpts.datesDisabled) {
            config.datesDisabled = inOpts.datesDisabled.reduce(function (
              dates,
              dt
            ) {
        ...
        var Picker = /*#__PURE__*/ (function () {
          function Picker(datepicker) {
            ...
            var _element$firstChild$c = _slicedToArray(
            ...
            var _footer$firstChild$ch = _slicedToArray(
        ...
        function moveByArrowKey(datepicker, ev, direction, vertical) {
          ...
          switch (currentView.id) {
            ...
            default:
              ...
              addFn = addYears;
              testFn = function testFn(date) {
                return currentView.disabled.includes(
        ...
        var Datepicker = /** @class */ (function () {
          ...
          Datepicker.prototype.getDate = function () {
            ...
            if (
              !this._options.rangePicker &&
              this._datepickerInstance instanceof
                flowbite_datepicker_1.Datepicker
            ) {
          ...
          document
            ...
            .forEach(function ($datepickerEl) {
              if ($datepickerEl) {
                ...
                var autohide = $datepickerEl.hasAttribute(
                  'datepicker-autohide'
                );
                var format = $datepickerEl.getAttribute('datepicker-format');
                var maxDate = $datepickerEl.getAttribute('datepicker-max-date');
                var minDate = $datepickerEl.getAttribute('datepicker-min-date');
                var orientation = $datepickerEl.getAttribute(
                  'datepicker-orientation'
                );
                var title = $datepickerEl.getAttribute('datepicker-title');
                var language = $datepickerEl.getAttribute(
                  'datepicker-language'
                );
                var rangePicker =
